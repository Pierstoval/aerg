        ...
        <section class="form-section">
            ...
            <div class="form-group">
                <div class="radio-group">
                    ...
                    <input type="radio" id="locale-en" bind:group={selectedLocale} value="en" on:change={updateLocale}>
                </div>

                <div class="radio-group">
                    <label for="locale-fr">🇫🇷</label>
                    <input type="radio" id="locale-fr" bind:group={selectedLocale} value="fr" on:change={updateLocale}>
                </div>
            </div>
